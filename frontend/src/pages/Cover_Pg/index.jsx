...
class CoverLetterPage extends Component {
  ...
  state = {currentDate:"", companyName:"developer", letterContent:[]}
    ...
    return (
      <div style={{height:"100%"}}>
        <div className={covers.letterBackground}>
          ...
          <div className={covers.letterContent}>{letterContent.content_0}</div>
          <div className={covers.letterContent}>{letterContent.content_1}</div>
          <div className={covers.letterContent}>{letterContent.content_2}</div>
          <div className={covers.letterContent}>{letterContent.content_3}</div>
